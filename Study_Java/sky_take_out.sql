...
-- ----------------------------
INSERT INTO `address_book` VALUES (2, 4, '123', '1', '13102182013', '11', '北京市', '1101', '市辖区', '110102', '西城区', '123124234534', '3', 1);
INSERT INTO `address_book` VALUES (3, 4, '2342', '0', '19012563025', '23', '黑龙江省', '2305', '双鸭山市', '230502', '尖山区', '12314234', '2', 0);
...
INSERT INTO `category` VALUES (16, 1, '蜀味烤鱼', 4, 1, '2022-06-09 22:15:37', '2025-07-27 07:24:08', 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '菜品' ROW_FORMAT = Dynamic;
...
INSERT INTO `dish` VALUES (68, '鸡蛋汤', 21, 4.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/c09a0ee8-9d19-428d-81b9-746221824113.png', '配料：鸡蛋，紫菜', 0, '2022-06-10 10:54:25', '2025-07-31 16:22:50', 1, 1);
...
INSERT INTO `dish` VALUES (71, '酸菜鱼鱼鱼鱼鱼', 16, 123.00, 'http://localhost:8080/Image/0ef6dc01-e8a3-4a67-9ca2-ac86a4ac9345_basicavator.jpg', '123', 0, '2025-07-28 14:40:57', '2025-07-31 16:20:52', 1, 1);
...
INSERT INTO `dish_flavor` VALUES (106, 71, '甜味', '[\"无糖\",\"少糖\",\"半糖\",\"多糖\",\"全糖\"]');
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '管理员', 'admin', '$2a$10$uFt6u1JD/GULC5ad6171eeFpN8Dn5VzrkzNazfkjde7j8kFoMKvm.', '13812312312', '1', '110101199001010047', 1, '2022-02-15 15:51:20', '2022-02-17 09:16:20', 10, 1);
INSERT INTO `employee` VALUES (2, '暨玉梅', '苟浩辰', '$2a$10$f6VQgtjhEfEDsmPKSiGRF.FXUcDphLJWpxiykfIiwYL0s51uhONju', '13561474326', '1', '36', 1, '2025-07-25 20:45:14', '2025-07-25 20:45:14', 10, 10);
INSERT INTO `employee` VALUES (3, '枫梓', '123456', '$2a$10$IWNxOsTZTJkVNP0zfrRbiOH69c4zrTnvGIDOrAoAlbYIHGX8AIcPS', '13872312311', '1', '341503200109128073', 1, '2025-07-25 21:07:01', '2025-07-25 21:07:01', 10, 10);
INSERT INTO `employee` VALUES (6, '堂语汐', '3132122222', '$2a$10$qoWNkkJGY1mGuIO1OjPbGuY0shUpJpzHh2X5HiFWG8i7DL0ih8Mzm', '16122343466', '1', '110301199001010047', 1, '2025-07-26 07:52:39', '2025-07-27 10:50:48', 1, 1);
...
CREATE TABLE `order_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '订单明细表' ROW_FORMAT = Dynamic;
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (4, '1754053378800', 6, 4, 2, '2025-08-01 21:02:59', NULL, 1, 0, 79.00, '', '13102182013', NULL, NULL, '123', '订单超时，自动取消', NULL, '2025-08-03 12:11:07', '2025-08-01 22:02:00', 0, NULL, 1, 0, 0);
...
-- Records of setmeal
-- ----------------------------
INSERT INTO `setmeal` VALUES (32, 13, '测试套餐', 123.00, 1, '213', 'http://localhost:8080/Image/0b174cbe-f864-4a98-9218-892e6ed4a492_OIP.jpg', NULL, '2025-07-31 21:13:18', NULL, 1);
...
CREATE TABLE `setmeal_dish`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '套餐菜品关系' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of setmeal_dish
-- ----------------------------
INSERT INTO `setmeal_dish` VALUES (53, 32, 65, '草鱼2斤', 68.00, 1);
INSERT INTO `setmeal_dish` VALUES (54, 32, 64, '馋嘴牛蛙', 88.00, 1);
INSERT INTO `setmeal_dish` VALUES (55, 32, 63, '香锅牛蛙', 88.00, 1);
INSERT INTO `setmeal_dish` VALUES (56, 32, 62, '金汤酸菜牛蛙', 88.00, 1);
...
CREATE TABLE `shopping_cart`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '购物车' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of shopping_cart
-- ----------------------------
INSERT INTO `shopping_cart` VALUES (16, '鮰鱼2斤', 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/8cfcc576-4b66-4a09-ac68-ad5b273c2590.png', 4, 67, NULL, '不辣', 1, 72.00, '2025-08-02 21:24:24');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (4, 'oMBFa18fPaTxFqV7vYcghlSB3jQo', NULL, NULL, NULL, NULL, NULL, '2025-07-30 20:56:29');
